 ...
 *   - pagemap_search       DuckDuckGo search
...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    description:
      "Web search via DuckDuckGo. Returns ranked {title,url,snippet} results. Use for lookups, news, and discovery.",
  ...
  pi.registerTool({
    ...
    label: "PageMap Fetch",
    description:
      "Fetch a URL and return extracted markdown (default), text, html, or JSON. JS-rendered via CloakBrowser.",
